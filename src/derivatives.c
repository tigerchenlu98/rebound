...
struct reb_particle reb_derivatives_lambda(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double ddxi_dlambda  = an / ((1. - q) * (1. - q)) * dq_dlambda * (-slp + q / (2. - l) * h) + an / (1. - q) * (-dslp_dlambda + dq_dlambda / (2. - l) * h);
    double ddeta_dlambda = an / ((1. - q) * (1. - q)) * dq_dlambda * (+clp - q / (2. - l) * k) + an / (1. - q) * (dclp_dlambda - dq_dlambda / (2. - l) * k);
...
struct reb_particle reb_derivatives_h(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double an       = sqrt(G * (po.m + primary.m) / a);
    double ddxi_dh  = dq_dh * an / ((1. - q) * (1. - q)) * (-slp + q / (2. - l) * h) + an / (1. - q) * (-dslp_dh + dq_dh / (2. - l) * h + dl_dh * q / ((2. - l) * (2. - l)) * h + q / (2. - l));
    double ddeta_dh = dq_dh * an / ((1. - q) * (1. - q)) * (+clp - q / (2. - l) * k) + an / (1. - q) * (+dclp_dh - dq_dh / (2. - l) * k - dl_dh * q / ((2. - l) * (2. - l)) * k);
...
struct reb_particle reb_derivatives_k(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double an       = sqrt(G * (po.m + primary.m) / a);
    double ddxi_dk  = dq_dk * an / ((1. - q) * (1. - q)) * (-slp + q / (2. - l) * h) + an / (1. - q) * (-dslp_dk + dq_dk / (2. - l) * h + dl_dk * q / ((2. - l) * (2. - l)) * h);
    double ddeta_dk = dq_dk * an / ((1. - q) * (1. - q)) * (+clp - q / (2. - l) * k) + an / (1. - q) * (+dclp_dk - dq_dk / (2. - l) * k - dl_dk * q / ((2. - l) * (2. - l)) * k - q / (2. - l));
...
struct reb_particle reb_derivatives_k_k(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double deta_dkk = a * (dslp_dkk - dp_dkk / (2. - l) * k - dl_dk * dp_dk / ((2. - l) * (2. - l)) * k - dp_dk / (2. - l) - dp_dk / (2. - l) - dl_dk * p / ((2. - l) * (2. - l)) - dp_dk / ((2. - l) * (2. - l)) * dl_dk * k - 2. * dl_dk * p / ((2. - l) * (2. - l) * (2. - l)) * dl_dk * k - p / ((2. - l) * (2. - l)) * dl_dkk * k - p / ((2. - l) * (2. - l)) * dl_dk);
...
struct reb_particle reb_derivatives_h_h(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double dxi_dhh  = a * (dclp_dhh + (dp_dhh / (2. - l) * h + dl_dh * dp_dh / ((2. - l) * (2. - l)) * h + dp_dh / (2. - l)) + (dp_dh / (2. - l) + dl_dh * p / ((2. - l) * (2. - l))) + (dp_dh / ((2. - l) * (2. - l)) * dl_dh * h + 2. * p / ((2. - l) * (2. - l) * (2. - l)) * dl_dh * dl_dh * h + p / ((2. - l) * (2. - l)) * dl_dhh * h + p / ((2. - l) * (2. - l)) * dl_dh));
...
struct reb_particle reb_derivatives_lambda_lambda(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double an                  = sqrt(G * (po.m + primary.m) / a);
    double ddxi_dlambdalambda  = 2. * an / ((1. - q) * (1. - q) * (1. - q)) * dq_dlambda * dq_dlambda * (-slp + q / (2. - l) * h) + an / ((1. - q) * (1. - q)) * dq_dlambdalambda * (-slp + q / (2. - l) * h) + an / ((1. - q) * (1. - q)) * dq_dlambda * (-dslp_dlambda + dq_dlambda / (2. - l) * h) + an / ((1. - q) * (1. - q)) * dq_dlambda * (-dslp_dlambda + dq_dlambda / (2. - l) * h) + an / (1. - q) * (-dslp_dlambdalambda + dq_dlambdalambda / (2. - l) * h);
    double ddeta_dlambdalambda = 2. * an / ((1. - q) * (1. - q) * (1. - q)) * dq_dlambda * dq_dlambda * (+clp - q / (2. - l) * k) + an / ((1. - q) * (1. - q)) * dq_dlambdalambda * (+clp - q / (2. - l) * k) + an / ((1. - q) * (1. - q)) * dq_dlambda * (dclp_dlambda - dq_dlambda / (2. - l) * k) + an / ((1. - q) * (1. - q)) * dq_dlambda * (dclp_dlambda - dq_dlambda / (2. - l) * k) + an / (1. - q) * (dclp_dlambdalambda - dq_dlambdalambda / (2. - l) * k);
...
struct reb_particle reb_derivatives_k_lambda(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double an             = sqrt(G * (po.m + primary.m) / a);
    double ddxi_dklambda  = dq_dklambda * an / ((1. - q) * (1. - q)) * (-slp + q / (2. - l) * h) + 2. * dq_dk * dq_dlambda * an / ((1. - q) * (1. - q) * (1. - q)) * (-slp + q / (2. - l) * h) + dq_dk * an / ((1. - q) * (1. - q)) * (-dslp_dlambda + dq_dlambda / (2. - l) * h) + dq_dlambda * an / ((1. - q) * (1. - q)) * (-dslp_dk + dq_dk / (2. - l) * h + dl_dk * q / ((2. - l) * (2. - l)) * h) + an / (1. - q) * (-dslp_dklambda + dq_dklambda / (2. - l) * h + dl_dk * dq_dlambda / ((2. - l) * (2. - l)) * h);
    double ddeta_dklambda = dq_dklambda * an / ((1. - q) * (1. - q)) * (+clp - q / (2. - l) * k) + 2. * dq_dk * dq_dlambda * an / ((1. - q) * (1. - q) * (1. - q)) * (+clp - q / (2. - l) * k) + dq_dk * an / ((1. - q) * (1. - q)) * (+dclp_dlambda - dq_dlambda / (2. - l) * k) + dq_dlambda * an / ((1. - q) * (1. - q)) * (+dclp_dk - dq_dk / (2. - l) * k - dl_dk * q / ((2. - l) * (2. - l)) * k - q / (2. - l)) + an / (1. - q) * (+dclp_dklambda - dq_dklambda / (2. - l) * k - dl_dk * dq_dlambda / ((2. - l) * (2. - l)) * k - dq_dlambda / (2. - l));
...
struct reb_particle reb_derivatives_h_lambda(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double an             = sqrt(G * (po.m + primary.m) / a);
    double ddxi_dhlambda  = dq_dhlambda * an / ((1. - q) * (1. - q)) * (-slp + q / (2. - l) * h) + 2. * dq_dlambda * dq_dh * an / ((1. - q) * (1. - q) * (1. - q)) * (-slp + q / (2. - l) * h) + dq_dh * an / ((1. - q) * (1. - q)) * (-dslp_dlambda + dq_dlambda / (2. - l) * h) + dq_dlambda * an / ((1. - q) * (1. - q)) * (-dslp_dh + dq_dh / (2. - l) * h + dl_dh * q / ((2. - l) * (2. - l)) * h + q / (2. - l)) + an / (1. - q) * (-dslp_dhlambda + dq_dhlambda / (2. - l) * h + dl_dh * dq_dlambda / ((2. - l) * (2. - l)) * h + dq_dlambda / (2. - l));
    double ddeta_dhlambda = dq_dhlambda * an / ((1. - q) * (1. - q)) * (+clp - q / (2. - l) * k) + 2. * dq_dh * dq_dlambda * an / ((1. - q) * (1. - q) * (1. - q)) * (+clp - q / (2. - l) * k) + dq_dh * an / ((1. - q) * (1. - q)) * (+dclp_dlambda - dq_dlambda / (2. - l) * k) + dq_dlambda * an / ((1. - q) * (1. - q)) * (+dclp_dh - dq_dh / (2. - l) * k - dl_dh * q / ((2. - l) * (2. - l)) * k) + an / (1. - q) * (+dclp_dhlambda - dq_dhlambda / (2. - l) * k - dl_dh * dq_dlambda / ((2. - l) * (2. - l)) * k);
...
struct reb_particle reb_derivatives_k_h(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double dxi_dkh  = a * (dclp_dkh + dp_dkh / (2. - l) * h + dl_dh * dp_dk / ((2. - l) * (2. - l)) * h + dp_dk / (2. - l) + dp_dh / ((2. - l) * (2. - l)) * dl_dk * h + 2. * p / ((2. - l) * (2. - l) * (2. - l)) * dl_dk * dl_dh * h + p / ((2. - l) * (2. - l)) * dl_dkh * h + p / ((2. - l) * (2. - l)) * dl_dk);
    double deta_dkh = a * (dslp_dkh - dp_dkh / (2. - l) * k - dl_dh * dp_dk / ((2. - l) * (2. - l)) * k - dp_dh / (2. - l) - dl_dh * p / ((2. - l) * (2. - l)) - dp_dh / ((2. - l) * (2. - l)) * dl_dk * k - p / ((2. - l) * (2. - l)) * dl_dkh * k - 2. * p / ((2. - l) * (2. - l) * (2. - l)) * dl_dk * dl_dh * k);
...
struct reb_particle reb_derivatives_a_lambda(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double dan_da         = -0.5 * sqrt(G * (po.m + primary.m) / (a * a * a));
    double ddxi_dalambda  = dan_da / ((1. - q) * (1. - q)) * dq_dlambda * (-slp + q / (2. - l) * h) + dan_da / (1. - q) * (-dslp_dlambda + dq_dlambda / (2. - l) * h);
    double ddeta_dalambda = dan_da / ((1. - q) * (1. - q)) * dq_dlambda * (+clp - q / (2. - l) * k) + dan_da / (1. - q) * (dclp_dlambda - dq_dlambda / (2. - l) * k);
...
struct reb_particle reb_derivatives_a_h(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double dan_da    = -0.5 * sqrt(G * (po.m + primary.m) / (a * a * a));
    double ddxi_dah  = dq_dh * dan_da / ((1. - q) * (1. - q)) * (-slp + q / (2. - l) * h) + dan_da / (1. - q) * (-dslp_dh + dq_dh / (2. - l) * h + dl_dh * q / ((2. - l) * (2. - l)) * h + q / (2. - l));
    double ddeta_dah = dq_dh * dan_da / ((1. - q) * (1. - q)) * (+clp - q / (2. - l) * k) + dan_da / (1. - q) * (+dclp_dh - dq_dh / (2. - l) * k - dl_dh * q / ((2. - l) * (2. - l)) * k);
...
struct reb_particle reb_derivatives_a_k(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double dan_da    = -0.5 * sqrt(G * (po.m + primary.m) / (a * a * a));
    double ddxi_dak  = dq_dk * dan_da / ((1. - q) * (1. - q)) * (-slp + q / (2. - l) * h) + dan_da / (1. - q) * (-dslp_dk + dq_dk / (2. - l) * h + dl_dk * q / ((2. - l) * (2. - l)) * h);
    double ddeta_dak = dq_dk * dan_da / ((1. - q) * (1. - q)) * (+clp - q / (2. - l) * k) + dan_da / (1. - q) * (+dclp_dk - dq_dk / (2. - l) * k - dl_dk * q / ((2. - l) * (2. - l)) * k - q / (2. - l));
...
struct reb_particle reb_derivatives_m_lambda(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double dan_dm         = 0.5 * sqrt(G / (a * (po.m + primary.m)));
    double ddxi_dmlambda  = dan_dm / ((1. - q) * (1. - q)) * dq_dlambda * (-slp + q / (2. - l) * h) + dan_dm / (1. - q) * (-dslp_dlambda + dq_dlambda / (2. - l) * h);
    double ddeta_dmlambda = dan_dm / ((1. - q) * (1. - q)) * dq_dlambda * (+clp - q / (2. - l) * k) + dan_dm / (1. - q) * (dclp_dlambda - dq_dlambda / (2. - l) * k);
...
struct reb_particle reb_derivatives_m_h(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double dan_dm    = 0.5 * sqrt(G / (a * (po.m + primary.m)));
    double ddxi_dmh  = dq_dh * dan_dm / ((1. - q) * (1. - q)) * (-slp + q / (2. - l) * h) + dan_dm / (1. - q) * (-dslp_dh + dq_dh / (2. - l) * h + dl_dh * q / ((2. - l) * (2. - l)) * h + q / (2. - l));
    double ddeta_dmh = dq_dh * dan_dm / ((1. - q) * (1. - q)) * (+clp - q / (2. - l) * k) + dan_dm / (1. - q) * (+dclp_dh - dq_dh / (2. - l) * k - dl_dh * q / ((2. - l) * (2. - l)) * k);
...
struct reb_particle reb_derivatives_m_k(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double dan_dm    = 0.5 * sqrt(G / (a * (po.m + primary.m)));
    double ddxi_dmk  = dq_dk * dan_dm / ((1. - q) * (1. - q)) * (-slp + q / (2. - l) * h) + dan_dm / (1. - q) * (-dslp_dk + dq_dk / (2. - l) * h + dl_dk * q / ((2. - l) * (2. - l)) * h);
    double ddeta_dmk = dq_dk * dan_dm / ((1. - q) * (1. - q)) * (+clp - q / (2. - l) * k) + dan_dm / (1. - q) * (+dclp_dk - dq_dk / (2. - l) * k - dl_dk * q / ((2. - l) * (2. - l)) * k - q / (2. - l));
...
struct reb_particle reb_derivatives_e_f(double G, struct reb_particle primary, struct reb_particle po) {
    ...
    double cosf           = cos(o.f);
    double dr             = -o.a * (cosf * o.e * o.e + cosf + 2. * o.e) / ((cosf * o.e + 1.) * (cosf * o.e + 1.));
    double ddr            = -o.a * (-sin(o.f) * o.e * o.e - sin(o.f)) / ((cosf * o.e + 1.) * (cosf * o.e + 1.)) - 2. * o.e * sin(o.f) * o.a * (cosf * o.e * o.e + cosf + 2. * o.e) / ((cosf * o.e + 1.) * (cosf * o.e + 1.) * (cosf * o.e + 1.));
    double dv0            = sqrt(G * (po.m + primary.m) / o.a) * o.e / ((1. - o.e * o.e) * sqrt(1. - o.e * o.e));
