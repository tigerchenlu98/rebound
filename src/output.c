...
const struct reb_binary_field_descriptor reb_binary_field_descriptor_list[]= {
    ...
    { 166, REB_DOUBLE,      "ri_trace.peri_crit_eta",       offsetof(struct reb_simulation, ri_trace.peri_crit_eta), 0, 0},
    { 167, REB_DOUBLE,      "ri_trace.peri_crit_fdot",      offsetof(struct reb_simulation, ri_trace.peri_crit_fdot), 0, 0},
    { 168, REB_DOUBLE,      "ri_trace.peri_crit_distance",  offsetof(struct reb_simulation, ri_trace.peri_crit_distance), 0, 0},
    { 169, REB_DOUBLE,      "ri_trace.last_dt_ias15",       offsetof(struct reb_simulation, ri_trace.last_dt_ias15), 0, 0},
    { 170, REB_INT,         "ri_trace.peri_encounters",     offsetof(struct reb_simulation, ri_trace.peri_encounters), 0, 0},
    { 171, REB_INT,         "ri_trace.close_encounters",    offsetof(struct reb_simulation, ri_trace.close_encounters), 0, 0},
