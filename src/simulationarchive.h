...
void reb_read_simulationarchive_with_messages(struct reb_simulationarchive* sa, const char* filename, enum reb_input_binary_messages* warnings, long nblobsmax); ///< Internal function to read one snapshot from a simulation archive.
